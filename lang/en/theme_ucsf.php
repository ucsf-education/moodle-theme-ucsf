...
$string['headerimage'] = 'Logo';
$string['headerimagealt'] = 'Logo description ';
$string['headerimagealtdesc'] = 'A textual description of the logo.';
$string['headerimagedesc'] = 'A custom logo to display in the page header for pages in this category. This takes the place of the site-wide default logo. If no logo is provided, no custom branding will be applied.';
$string['headerimagelink'] = 'Logo link';
$string['headerimagelinkdesc'] = 'A URL that the logo links to.';
$string['headerimagelinktarget'] = 'Open logo link in new window';
$string['headerimagelinktargetdesc'] = "Check to have this logo's link open up in a new window.";
$string['headerimagesubsectiontitle'] = 'Branding';
$string['headerimagetitle'] = 'Logo link title';
$string['headerimagetitledesc'] = 'A textual description of the logo link target URL.';
