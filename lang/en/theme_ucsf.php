...
$string['enablecoursecatalognavlink'] = 'Show course catalog link';
$string['enablecoursecatalognavlinkdesc'] = 'If enabled, a link to the "Course Catalog" will appear in the primary navigation for all users with category-manager capabilities.';
