...
/**
 * Admin settings form component for selecting a start date, and an end date (year, month, and day).
 *
...
/**
 * Admin settings form component for selecting a start time, and an end time (hours and minutes).
 *
 * @author Dusan Sparavalo <dusan.sparavalo@lambdasolutions.net>
 * @author Stefan Topfstedt <stefan.topfstedt@ucsf.edu>
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class theme_ucsf_timepicker extends admin_setting {
...
/**
 * Admin settings form component for selecting a start datetime, and an end datetime (year, month, day, hours, and minutes).
 *
 * @author Sasa Prsir <sasa.prsir@lambdasolutions.net>
 * @author Stefan Topfstedt <stefan.topfstedt@ucsf.edu>
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class theme_ucsf_datetimepicker extends admin_setting {
    const START_DATE = 'start_date';
    const START_HOUR = 'start_hour';
    const START_MINUTE = 'start_minute';
    const END_DATE = 'end_date';
